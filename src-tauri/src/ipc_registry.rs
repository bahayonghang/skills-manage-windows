...
macro_rules! __skillport_runtime_commands {
    ($callback:ident) => {
        $callback! {
            ...
            skills_cli_link_platform_batch => (commands::skills_cli::skills_cli_link_platform_batch, operation(SkillsCli, Filesystem, StartedThenTerminal)),
            ...
            skills_cli_unlink_platform_batch => (commands::skills_cli::skills_cli_unlink_platform_batch, operation(SkillsCli, Filesystem, StartedThenTerminal)),
...
macro_rules! __skillport_generated_commands {
    ($callback:ident) => {
        $callback! {
            ...
            skills_cli_link_platform_batch => commands::skills_cli::skills_cli_link_platform_batch,
            skills_cli_unlink_platform => commands::skills_cli::skills_cli_unlink_platform,
            skills_cli_unlink_platform_batch => commands::skills_cli::skills_cli_unlink_platform_batch,
