...
export function FacetSection({
  ...
  return (
    <section data-testid={testId}>
      <div className="sticky top-0 z-10 -mx-3 flex items-center gap-1.5 border-b border-border/50 bg-background/90 px-4 py-2 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground backdrop-blur-md">
        <button
          type="button"
