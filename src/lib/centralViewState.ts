...
import type { CentralSortDirection, CentralSortField } from "@/pages/centralSkillsViewModel";
 ...
 */
export function parseCentralViewState(params: URLSearchParams): CentralViewState {
  ...
  if (sortRaw) {
    ...
    sortField = pickEnum(fieldPart ?? null, SORT_FIELDS, DEFAULT_STATE.sortField);
