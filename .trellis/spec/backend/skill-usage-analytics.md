...
or the usage Tauri commands. It protects three invariants: provider logs remain
immutable facts, skill identity is never guessed, and calendar buckets follow the
machine running SkillPort rather than UTC.
