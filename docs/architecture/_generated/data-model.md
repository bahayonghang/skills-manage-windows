...
| `link_type` | `TEXT  CHECK (link_type IN ('native', 'symlink', 'copy', 'writable'))` | no | — | — |
...
| `skill_id` | `TEXT` | no | — | — |
| `skill_name` | `TEXT` | no | — | — |
| `conflict_existing_skill_id` | `TEXT` | yes | — | — |
...
| `scope_kind` | `TEXT` | no | — | — |
| `mode` | `TEXT` | no | — | — |
| `skill_ids_json` | `TEXT` | yes | — | — |
| `repository_ids_json` | `TEXT` | yes | — | — |
| `agent_ids_json` | `TEXT` | yes | — | — |
| `cache_policy` | `TEXT` | no | — | — |
...
| `agent_id` | `TEXT` | yes | — | — |
| `local_hash` | `TEXT` | yes | — | — |
| `baseline_hash` | `TEXT` | yes | — | — |
| `remote_hash` | `TEXT` | yes | — | — |
| `local_version` | `TEXT` | yes | — | — |
| `remote_version` | `TEXT` | yes | — | — |
| `cache_policy` | `TEXT` | no | — | — |
| `cache_hit` | `INTEGER` | no | `0` | — |
| `snapshot_fetched_at` | `TEXT` | yes | — | — |
| `generated_at` | `TEXT` | no | — | — |
...
| --- | --- | --- | --- | --- |
| `id` | `INTEGER  AUTOINCREMENT` | yes | — | ✓ |
| `target_id` | `TEXT` | no | `'local'` | — |
| `skill` | `TEXT` | no | — | — |
| `timestamp_ms` | `INTEGER` | no | — | — |
| `project` | `TEXT` | no | — | — |
| `session_id` | `TEXT` | no | — | — |
| `source` | `TEXT` | no | — | — |
...
| `target_id` | `TEXT` | no | — | ✓ |
| `skill` | `TEXT` | no | — | ✓ |
| `match_status` | `TEXT  CHECK (match_status IN ('matched', 'ambiguous', 'unmatched'))` | no | — | — |
| `resolved_skill_id` | `TEXT` | yes | — | — |
| `static_token_estimate` | `INTEGER CHECK (static_token_estimate >= 0)` | yes | — | — |
| `static_byte_count` | `INTEGER CHECK (static_byte_count >= 0)` | yes | — | — |
