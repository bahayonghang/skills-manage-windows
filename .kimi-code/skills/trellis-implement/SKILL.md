...
description: |
  ...
  the first prompt line must be Active task: <path>. Live project-agent
  discovery remains UNVERIFIED; this is a prompt convention, not a claim
  that Kimi lacks project custom agents.
---
...
- Stay inside the approved file and permission scope; escalate when a new failure appears or scope would grow
